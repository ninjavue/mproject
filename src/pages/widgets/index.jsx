        ...
        <>
            <div>
                <div className="flex flex-wrap items-center justify-between gap-2 mb-6">
                    <h6 className="font-semibold mb-0 dark:text-white">Widgets</h6>
                    <ul className="flex items-center gap-[6px]">
                        ...
                        <li className="font-medium dark:text-white">Widgets</li>
                    </ul>
                </div>
                <div className="card h-full p-0 rounded-xl border-0 overflow-hidden">
                    <div className="card-header border-b border-neutral-200 dark:border-neutral-600 bg-white dark:bg-neutral-700 py-4 px-6">
                        <h6 className="text-lg font-semibold mb-0">Metrics</h6>
                    </div>
                    <div className="card-body p-6 flex flex-col gap-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 border border-neutral-200 dark:border-neutral-600">
                            <div className="card-body p-6 h-full flex flex-col sm:border-r border-r-0 border-neutral-200 dark:border-neutral-600 last:border-r-0 border-b lg:border-b-0">
                            ...
                            <div className="card-body p-6 h-full flex flex-col lg:border-r border-r-0 border-neutral-200 dark:border-neutral-600 last:border-r-0 border-b lg:border-b-0">
                                <div className="flex flex-wrap items-center justify-between gap-1 mb-0.5">
                                    <div>
                            ...
                            <div className="card-body p-6 h-full flex flex-col sm:border-r border-r-0 border-neutral-200 dark:border-neutral-600 last:border-r-0 border-b sm:border-b-0">
                                <div className="flex flex-wrap items-center justify-between gap-1 mb-0.5">
                                    <div>
                            ...
                            <div className="card-body p-6 h-full flex flex-col sm:border-r border-r-0 border-neutral-200 dark:border-neutral-600 last:border-r-0">
                                <div className="flex flex-wrap items-center justify-between gap-1 mb-0.5">
                                    <div>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <div className="h-full border border-neutral-200 dark:border-neutral-600 p-4 pe-0 rounded-lg">
                                        <div className="max-h-[266px] overflow-y-auto scroll-sm pe-6">
                                            ...
                                            <div className="flex items-center justify-between gap-3 mb-3 pb-2">
                                                <div className="flex items-center w-full">
                                                    <img src="../assets/images/flags/flag5.png" alt className="w-10 h-10 rounded-full shrink-0 me-4" />
                                                    <div className="grow">
                                ...
                                <div className="mt-6">
                                    <div className="flex items-center gap-1 justify-between mb-11">
                                        ...
                                        <div className="relative">
                                            ...
                                            <span className="w-9 h-9 rounded-full bg-neutral-100 flex justify-center items-center absolute left-1/2 -translate-x-1/2 translate-y-[16px] top-1/2"><iconify-icon icon="mdi:emoji" className="text-primary-600 text-base mb-0" /></span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-1 justify-between mb-11">
                                        <div>
