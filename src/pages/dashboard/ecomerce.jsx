            ...
            <div>
                <div className="flex flex-wrap items-center justify-between gap-2 mb-6">
                    ...
                    <ul className="flex items-center gap-[6px]">
                        ...
                        <li className="font-medium dark:text-white">eCommerce</li>
                    </ul>
                </div>
                                            ...
                                            <div className="flex flex-wrap items-center justify-between gap-1 mb-0.5">
                                                <div>
                                                    <span className="w-[44px] h-[44px] text-primary-600 dark:text-primary-500 bg-primary-600/20 border border-primary-300 dark:border-primary-600/50 shrink-0 flex justify-center items-center rounded-lg h6 mb-4">
                                                        <iconify-icon icon="fa-solid:box-open" className="icon" />
                                                    </span>
                                                    <span className="mb-1 font-medium text-secondary-light text-base">Total Products</span>
                                                    <h6 className="font-semibold text-neutral-900 mt-2 mb-px">300</h6>
                                                </div>
                                            </div>
                                            <p className="text-sm mb-0 mt-3">Increase by  <span className="bg-success-100 dark:bg-success-600/25 px-1 py-0.5 rounded-sm font-medium text-success-600 dark:text-success-500 text-sm">+200</span> this week</p>
                                        </div>
                                        <div className="card-body p-6 h-full flex flex-col border-b border-neutral-200 dark:border-neutral-600">
                                            <div className="flex flex-wrap items-center justify-between gap-1 mb-0.5">
                                                <div>
                                                    ...
                                                    <span className="mb-1 font-medium text-secondary-light text-base">Total Customer</span>
                                                    <h6 className="font-semibold text-neutral-900 mt-2 mb-px">50,000</h6>
                                                </div>
                                            </div>
                                            <p className="text-sm mb-0 mt-3">Increase by  <span className="bg-danger-100 dark:bg-danger-600/25 px-1 py-0.5 rounded-sm font-medium text-danger-600 dark:text-danger-500 text-sm">-5k</span> this week</p>
                                        </div>
                                            ...
                                            <div className="flex flex-wrap items-center justify-between gap-1 mb-0.5">
                                                <div>
                                                    <span className="w-[44px] h-[44px] text-purple-600 dark:text-purple-500 bg-purple-600/20 border border-purple-300 dark:border-purple-600/50 shrink-0 flex justify-center items-center rounded-lg h6 mb-4">
                                                        <iconify-icon icon="majesticons:shopping-cart" className="icon" />
                                                    </span>
                                                    <span className="mb-1 font-medium text-secondary-light text-base">Total Orders</span>
                                                    <h6 className="font-semibold text-neutral-900 mt-2 mb-px">1400</h6>
                                                </div>
                                            </div>
                                            <p className="text-sm mb-0 mt-3">Increase by  <span className="bg-success-100 dark:bg-success-600/25 px-1 py-0.5 rounded-sm font-medium text-success-600 dark:text-success-500 text-sm">+1k</span> this week</p>
                                        </div>
                                            ...
                                            <div className="flex flex-wrap items-center justify-between gap-1 mb-0.5">
                                                <div>
                                                    <span className="w-[44px] h-[44px] text-pink-600 dark:text-pink-500 bg-pink-600/20 border border-pink-300 dark:border-pink-600/50 shrink-0 flex justify-center items-center rounded-lg h6 mb-4">
                                                        <iconify-icon icon="ri:discount-percent-fill" className="icon" />
                                                    </span>
                                                    <span className="mb-1 font-medium text-secondary-light text-base">Total Sales</span>
                                                    <h6 className="font-semibold text-neutral-900 mt-2 mb-px">$25,00,000.00</h6>
                                                </div>
                                            </div>
                                            <p className="text-sm mb-0 mt-3">Increase by  <span className="bg-success-100 dark:bg-success-600/25 px-1 py-0.5 rounded-sm font-medium text-success-600 dark:text-success-500 text-sm">+$10k</span> this week</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="card h-full rounded-lg border-0">
                            <div className="card-body p-6">
                                ...
                                <div className="relative">
                                    <span className="w-[80px] h-[80px] bg-white dark:bg-neutral-700 shadow-lg text-neutral-600 dark:text-neutral-200 font-semibold text-xl flex justify-center items-center rounded-full absolute end-0 top-0 z-1">+30%</span>
                                    <div id="statisticsDonutChart" className="mt-9 grow apexcharts-tooltip-z-none title-style circle-none" />
                                    <span className="w-[80px] h-[80px] bg-white dark:bg-neutral-700 shadow-lg text-neutral-600 dark:text-neutral-200 font-semibold text-xl flex justify-center items-center rounded-full absolute start-0 bottom-0 z-1">+25%</span>
                                </div>
                                    ...
                                    <table className="table bordered-table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>2</td>
                                                <td>$5,000.00</td>
                                                <td className="text-center"> <span className="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 px-6 py-1.5 rounded-full font-medium text-sm">Paid</span> </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div className="flex items-center">
                                                ...
                                                <td>3</td>
                                                <td>$1,000.00</td>
                                                <td className="text-center"> <span className="bg-warning-100 dark:bg-warning-600/25 text-warning-600 dark:text-warning-400 px-6 py-1.5 rounded-full font-medium text-sm">Pending</span> </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div className="flex items-center">
                                                ...
                                                <td>7</td>
                                                <td>$1,000.00</td>
                                                <td className="text-center"> <span className="bg-info-100 dark:bg-info-600/25 text-info-600 dark:text-info-400 px-6 py-1.5 rounded-full font-medium text-sm">Shipped</span> </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div className="flex items-center">
                                                ...
                                                <td>1</td>
                                                <td>$3,000.00</td>
                                                <td className="text-center"> <span className="bg-danger-100 dark:bg-danger-600/25 text-danger-600 dark:text-danger-400 px-6 py-1.5 rounded-full font-medium text-sm">Canceled</span> </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div className="flex items-center">
                                ...
                                <div className="mt-8">
                                    <div className="flex items-center justify-between gap-3 mb-5">
                                        <div className="flex items-center gap-2">
                                            <img src="../assets/images/payment/payment1.png" alt className="w-10 h-10 rounded-lg shrink-0" />
                                            <div className="grow">
                                                <h6 className="text-base mb-0 font-normal">Paytm</h6>
                                                <span className="text-sm text-secondary-light font-normal">Starbucks</span>
                                            </div>
                                        </div>
                                        <span className="text-danger text-base font-medium">-$20</span>
                                    </div>
                                    <div className="flex items-center justify-between gap-3 mb-5">
                                        <div className="flex items-center gap-2">
                                            <img src="../assets/images/payment/payment2.png" alt className="w-10 h-10 rounded-lg shrink-0" />
                                            <div className="grow">
                                                <h6 className="text-base mb-0 font-normal">PayPal</h6>
                                                <span className="text-sm text-secondary-light font-normal">Client Payment</span>
                                            </div>
                                        </div>
                                        <span className="text-success-600 text-base font-medium">+$800</span>
                                    </div>
                                    <div className="flex items-center justify-between gap-3 mb-5">
                                        <div className="flex items-center gap-2">
                                            <img src="../assets/images/payment/payment3.png" alt className="w-10 h-10 rounded-lg shrink-0" />
                                            <div className="grow">
                                                <h6 className="text-base mb-0 font-normal">Stripe</h6>
                                                <span className="text-sm text-secondary-light font-normal">Ordered iPhone 14</span>
                                            </div>
                                        </div>
                                        <span className="text-danger-600 text-base font-medium">-$300</span>
                                    </div>
                                    <div className="flex items-center justify-between gap-3 mb-5">
                                        <div className="flex items-center gap-2">
                                            <img src="../assets/images/payment/payment4.png" alt className="w-10 h-10 rounded-lg shrink-0" />
                                            <div className="grow">
                                                <h6 className="text-base mb-0 font-normal">Razorpay</h6>
                                                <span className="text-sm text-secondary-light font-normal">Refund</span>
                                            </div>
                                        </div>
                                        <span className="text-success-600 text-base font-medium">+$400</span>
                                    </div>
                                    <div className="flex items-center justify-between gap-3 mb-5">
                                        <div className="flex items-center gap-2">
                                            <img src="../assets/images/payment/payment1.png" alt className="w-10 h-10 rounded-lg shrink-0" />
                                        ...
                                        <span className="text-danger-600 text-base font-medium">-$1400</span>
                                    </div>
                                ...
                                <div className>
                                    <div className="flex items-center justify-between gap-3 mb-3 pb-2">
                                        <div className="flex items-center w-full">
                                            <img src="../assets/images/flags/flag1.png" alt className="w-10 h-10 rounded-full shrink-0 me-4" />
                                            <div className="grow">
                                    ...
                                    <div className="flex items-center justify-between gap-3 mb-3 pb-2">
                                        <div className="flex items-center w-full">
                                            <img src="../assets/images/flags/flag2.png" alt className="w-10 h-10 rounded-full shrink-0 me-4" />
                                            <div className="grow">
                                    ...
                                    <div className="flex items-center justify-between gap-3 mb-3 pb-2">
                                        <div className="flex items-center w-full">
                                            <img src="../assets/images/flags/flag3.png" alt className="w-10 h-10 rounded-full shrink-0 me-4" />
                                            <div className="grow">
                                    ...
                                    <div className="flex items-center justify-between gap-3">
                                        <div className="flex items-center w-full">
                                            <img src="../assets/images/flags/flag4.png" alt className="w-10 h-10 rounded-full shrink-0 me-4" />
                                            <div className="grow">
                            ...
                            <div className="card-body">
                                ...
                                <div className="mt-8">
                                    <div className="flex items-center justify-between gap-3 mb-8">
                                        <div className="flex items-center gap-2">
                                            <img src="../assets/images/users/user6.png" alt className="w-10 h-10 rounded-lg shrink-0" />
                                            <div className="grow">
                                                <h6 className="text-base mb-0 font-normal">Dianne Russell</h6>
                                                <span className="text-sm text-secondary-light font-normal">017******58</span>
                                            </div>
                                        </div>
                                        <span className="text-neutral-600 dark:text-neutral-200 text-base font-medium">Orders: 30</span>
                                    </div>
                                    <div className="flex items-center justify-between gap-3 mb-8">
                                        <div className="flex items-center gap-2">
                                            <img src="../assets/images/users/user1.png" alt className="w-10 h-10 rounded-lg shrink-0" />
                                            <div className="grow">
                                                <h6 className="text-base mb-0 font-normal">Wade Warren</h6>
                                                <span className="text-sm text-secondary-light font-normal">017******58</span>
                                            </div>
                                        </div>
                                        <span className="text-neutral-600 dark:text-neutral-200 text-base font-medium">Orders: 30</span>
                                    ...
                                    <div className="flex items-center justify-between gap-3 mb-8">
                                        <div className="flex items-center gap-2">
                                            <img src="../assets/images/users/user2.png" alt className="w-10 h-10 rounded-lg shrink-0" />
                                            <div className="grow">
                                                <h6 className="text-base mb-0 font-normal">Albert Flores</h6>
                                                <span className="text-sm text-secondary-light font-normal">017******58</span>
                                            </div>
                                        </div>
                                        <span className="text-neutral-600 dark:text-neutral-200 text-base font-medium">Orders: 35</span>
                                    </div>
                                    <div className="flex items-center justify-between gap-3 mb-8">
                                        <div className="flex items-center gap-2">
                                            <img src="../assets/images/users/user3.png" alt className="w-10 h-10 rounded-lg shrink-0" />
                                            <div className="grow">
                                                <h6 className="text-base mb-0 font-normal">Bessie Cooper</h6>
                                                <span className="text-sm text-secondary-light font-normal">017******58</span>
                                            </div>
                                        </div>
                                        <span className="text-neutral-600 dark:text-neutral-200 text-base font-medium">Orders: 20</span>
                                    </div>
                                    <div className="flex items-center justify-between gap-3 mb-8">
                                        <div className="flex items-center gap-2">
                                            <img src="../assets/images/users/user4.png" alt className="w-10 h-10 rounded-lg shrink-0" />
                                            <div className="grow">
                                                <h6 className="text-base mb-0 font-normal">Arlene McCoy</h6>
                                                <span className="text-sm text-secondary-light font-normal">017******58</span>
                                            </div>
                                        </div>
                                        <span className="text-neutral-600 dark:text-neutral-200 text-base font-medium">Orders: 25</span>
                                    </div>
                                    <div className="flex items-center justify-between gap-3">
                                        <div className="flex items-center gap-2">
                                            <img src="../assets/images/users/user6.png" alt className="w-10 h-10 rounded-lg shrink-0" />
                                        ...
                                        <span className="text-neutral-600 dark:text-neutral-200 text-base font-medium">Orders: 32</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <td>
                                                    <div className="max-w-[44px]2 mx-auto">
                                                        <div className="w-full">
                                                            <div className="progress progress-sm rounded-full" role="progressbar" aria-label="Success example" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>
                                                                <div className="progress-bar bg-primary-600 rounded-full" style={{ width: '0%' }} />
                                                            </div>
                                                        </div>
                                                        <span className="mt-3 text-secondary-light text-sm font-medium">Out of Stock</span>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="max-w-[44px]2 mx-auto">
                                                        <div className="w-full">
                                                            <div className="progress progress-sm rounded-full" role="progressbar" aria-label="Success example" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>
                                                                <div className="progress-bar bg-danger-600 rounded-full" style={{ width: '40%' }} />
                                                            </div>
                                                        </div>
                                                        <span className="mt-3 text-secondary-light text-sm font-medium">18 Low Stock</span>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="max-w-[44px]2 mx-auto">
                                                        ...
                                                        <span className="mt-3 text-secondary-light text-sm font-medium">80 High Stock</span>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="max-w-[44px]2 mx-auto">
                                                        <div className="w-full">
                                                            <div className="progress progress-sm rounded-full" role="progressbar" aria-label="Success example" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>
                                                                <div className="progress-bar bg-success-600 rounded-full" style={{ width: '50%' }} />
                                                            </div>
                                                        </div>
                                                        <span className="mt-3 text-secondary-light text-sm font-medium">50 High Stock</span>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="max-w-[44px]2 mx-auto">
                                                        <div className="w-full">
                                                            <div className="progress progress-sm rounded-full" role="progressbar" aria-label="Success example" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>
                                                                <div className="progress-bar bg-success-600 rounded-full" style={{ width: '70%' }} />
                                                            </div>
                                                        </div>
                                                        <span className="mt-3 text-secondary-light text-sm font-medium">70 High Stock</span>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
