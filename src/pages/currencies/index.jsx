        ...
        <>
            <div>
                <div className="flex flex-wrap items-center justify-between gap-2 mb-6">
                    <h6 className="font-semibold mb-0 dark:text-white">Currencies</h6>
                    <ul className="flex items-center gap-[6px]">
                        ...
                        <li className="font-medium dark:text-white">Settings - Currencies</li>
                    </ul>
                </div>
                    ...
                    <div className="col-span-12">
                        <div className="card h-full p-0 rounded-xl border-0">
                            <div className="card-header border-b border-neutral-200 dark:border-neutral-600 bg-white dark:bg-neutral-700 py-4 px-6 flex items-center flex-wrap gap-3 justify-between">
                                ...
                                <button type="button" data-modal-target="add-currency-modal" data-modal-toggle="add-currency-modal" className="btn btn-primary text-sm btn-sm px-3 py-3 rounded-lg flex items-center gap-2">
                                    ...
                                    <table className="table bordered-table sm-table mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" className="text-center">Is Cryptocurrency</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td className="text-center">
                                                    <div className="flex items-center gap-3 justify-center">
                                                        <button type="button" data-modal-target="edit-currency-modal" data-modal-toggle="edit-currency-modal" className="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 bg-hover-success-200 font-medium w-10 h-10 flex justify-center items-center rounded-full">
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-center">
                                                    <div className="flex items-center gap-3 justify-center">
                                                        <button type="button" className="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 bg-hover-success-200 font-medium w-10 h-10 flex justify-center items-center rounded-full" data-modal-target="edit-currency-modal" data-modal-toggle="edit-currency-modal">
                                                            <iconify-icon icon="lucide:edit" className="menu-icon" />
                                                        </button>
                                                        <button type="button" className="remove-item-button bg-danger-100 bg-hover-danger-200 text-danger-600 font-medium w-10 h-10 flex justify-center items-center rounded-full">
                                                            <iconify-icon icon="fluent:delete-24-regular" className="menu-icon" />
